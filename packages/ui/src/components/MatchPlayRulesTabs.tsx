...
export function MatchPlayRulesTabs({ matchPlayRules, seniorRules }: MatchPlayRulesTabsProps) {
	const [activeTab, setActiveTab] = useState<TabKey>("match-play")

	const activeContent = activeTab === "match-play" ? matchPlayRules : seniorRules
