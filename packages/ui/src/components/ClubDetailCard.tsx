...
export function ClubDetailCard({
	...
	return (
		<Card>
			<CardHeader>
				<CardTitle>
					<H2 className="text-lg">Club Overview</H2>
				</CardTitle>
			</CardHeader>
			<CardContent>
					...
					{lastMemberYear && (
						<div className="flex items-start gap-3 text-gray-600">
							...
							<div className="text-sm">
								...
								{currentYearPaymentDate && (
									<p className="text-green-600">Joined {formatDate(currentYearPaymentDate)}</p>
								)}
							</div>
						</div>
					)}
				...
				{notes && (
					<div className="mt-4">
						<h3 className="mb-2 text-sm font-semibold text-gray-900">About the Club</h3>
