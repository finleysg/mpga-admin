...
export const tournamentInstanceRelations = relations(
  tournamentInstance,
  ({ one, many }) => ({
    announcements: many(announcement),
...
export const clubContactRoleRelations = relations(
  clubContactRole,
  ({ one }) => ({
...
export const matchPlayResultRelations = relations(
  matchPlayResult,
  ({ one }) => ({
...
export const tournamentHistoryRelations = relations(
  tournamentHistory,
  ({ one }) => ({
    tournament: one(tournament, {
