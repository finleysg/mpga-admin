	...
	return (
		<SheetContent className="sm:max-w-2xl w-full overflow-y-auto">
			<SheetHeader>
				...
				<SheetDescription>
					Click on the contacts to highlight all the contacts that should be merged. Star one of the
					contact records to serve as the merge target.
				</SheetDescription>
			</SheetHeader>
			...
			<SheetFooter>
				...
				<Button variant="secondary" disabled={!canMerge || merging} onClick={handleMerge}>
