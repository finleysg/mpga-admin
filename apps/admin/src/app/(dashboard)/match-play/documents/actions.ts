...
// ── List Match Play Documents ───────────────────────────────────────

export async function listMatchPlayDocumentsAction(
	year: number,
): Promise<ActionResult<DocumentDataFull[]>> {
	...
	try {
		...
		console.error("Failed to list match play documents:", error)
...
export async function getMatchPlayDocumentAction(
	id: number,
): Promise<ActionResult<DocumentDataFull>> {
	const userId = await requireAuth()
	if (!userId) {
...
export async function saveMatchPlayDocumentAction(
...
export async function deleteMatchPlayDocumentAction(id: number): Promise<ActionResult> {
	const userId = await requireAuth()
	if (!userId) {
		return { success: false, error: "Unauthorized" }
	}
...
export async function uploadMatchPlayDocumentFileAction(
	formData: FormData,
