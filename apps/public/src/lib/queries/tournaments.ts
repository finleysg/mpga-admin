...
export async function getTournamentsForYear(year: number): Promise<TournamentForYear[]> {
	try {
...
export function formatTournamentDates(startDate: string, rounds: number): string {
...
export async function getTournamentInstance(
	...
	try {
		...
		console.error(`Failed to fetch tournament instance ${systemName}/${year}:`, error)
		return null
	}
}
...
export async function getTournamentLinks(instanceId: number): Promise<TournamentLinkData[]> {
	try {
		const results = await db
			.select({
...
export async function getTournamentDocuments(
	...
	try {
		...
		console.error(`Failed to fetch tournament documents for ${tournamentId}/${year}:`, error)
		return []
	}
}
...
export async function getTournamentHistory(
	...
	try {
		...
		console.error(`Failed to fetch tournament history for ${tournamentId}:`, error)
		return []
	}
}
...
export async function getTournamentPhotos(tournamentId: number): Promise<TournamentPhotoRecord[]> {
	try {
		const results = await db
			.select({
				id: photo.id,
		...
		console.error(`Failed to fetch tournament photos for ${tournamentId}:`, error)
		return []
	}
}
...
export async function getTournamentHistoryDocuments(
	...
	try {
		...
		console.error(`Failed to fetch tournament history documents for ${tournamentId}:`, error)
		return []
	}
}
